...
class TestMessage(TestCase):
	...
	# Checking success message for running the script on a correct file (no colors)
    def test_message_1(self):
        result = messages.console_message('ok','check_message','file_name',with_color=False)
    ...
    def test_message_2(self):
        result = messages.console_message('error','status_code_error','link_name',with_color=False,with_tag=False)
